...
class InterpolatorIsotherm:
    ...
    def __init__(self,
        ...
        if fill_value is None:
            if interp_kind == 'UnivariateSpline':
                ...
                self.interp1d = UnivariateSpline(self.df[pressure_key], self.df[loading_key], ext=2, s=interp_s, w=interp_w)
            else:
            ...
            if interp_kind == 'UnivariateSpline':
                self.interp1d = UnivariateSpline(self.df[pressure_key], self.df[loading_key], ext=3, s=interp_s, w=interp_w)
            else:
